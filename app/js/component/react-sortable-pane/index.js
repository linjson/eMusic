...
export type SortablePaneProps = $Exact<{
    ...
    onResizeStart?: (e: SyntheticMouseEvent | SyntheticTouchEvent,
                     id: PaneId,
                     panes: PaneProperty[]) => void;
    onDragStart?: (e: SyntheticMouseEvent | SyntheticTouchEvent,
                   id: PaneId,
                   panes: PaneProperty[]) => void;
    onDragStop?: (e: MouseEvent | TouchEvent,
                  id: PaneId,
                  panes: PaneProperty[]) => void;
            ...
            return (
                <Motion style={style} key={child.props.id}>
                    {({scale, shadow, x, y}) => {
                        ...
                        const onMouseDown = isSortable ? this.handleLongPress.bind(this, i, x, y) : () => null;
                        const onTouchStart = this.handleLongPress.bind(this, i, x, y);
